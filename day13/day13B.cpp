    ...
    while(getline(cin, line))  {
        ...
        switch (num_dato){
            ...
            case FILA3: 
                ...
                calcula_movimientos(ax, ay, bx, by, px + 10000000000000, py + 10000000000000, total);
...
void calcula_movimientos(long long ax, long long ay, long long bx, long long by, long long px, long long py, long long &total)
{
    ...
    //alternativa
    long long y = (py * ax - px * ay) / ((-ay) * bx + by * ax);
    long long x = (px - bx * y) / ax;
